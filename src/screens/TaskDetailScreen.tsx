...
export default function TaskDetailScreen({ navigation, route }: Props) {
  ...
  if (!task) {
    return (
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: colors.surface }}>
        <Text style={{ color: colors['on-surface-variant'], fontSize: 14 }}>No se encontró la tarea.</Text>
      </View>
    );
  }
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.surface }}>
      ...
      <FlatList
        ...
        contentContainerStyle={{ paddingHorizontal: spacing['container-padding'], paddingBottom: 120 }}
